<template>
  <view class="page_revelation diy_table diy_table_tml" id="revelation_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/revelation/view?" v-show="user_group == '管理员' || $check_action('/revelation/table','add') || $check_action('/revelation/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>物品图片</span>
									...
									<view class="col" v-if="1 && $check_field('get','missing_address')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>丢失地址</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','lost_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>丢失时间</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/revelation/table','del') || $check_action('/revelation/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/revelation/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/revelation/table','set') || $check_action('/revelation/view','set') || $check_action('/revelation/view','get')" class="btn btn-primary">详情</navigator>
														</view>
			</view>
		</view>
	</view>
