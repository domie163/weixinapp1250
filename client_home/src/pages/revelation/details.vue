<template>
	<view class="page_revelation diy_detail diy_detail--new" id="revelation_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					...
					<view v-if="$check_field('get','missing_address')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>丢失地址</span>
							</view>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=revelation&source_field=revelation_id&source_id=' + obj['revelation_id']">
							评论
						</navigator>
	...
	export default {
		...
		methods: {
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "revelation",
					source_field: "revelation_id",
					source_id: obj["revelation_id"],
					user_id
				};
			...
			change_collect() {
				...
				var query = {
					source_table: "revelation",
					source_field: "revelation_id",
					source_id: this.obj["revelation_id"],
					user_id
				};
