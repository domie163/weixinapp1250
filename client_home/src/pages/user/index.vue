						...
						<view class="">
							<view  class="list_module">
									...
									<navigator class="my_module" url="/pages/system_user/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/revelation/table','get')">
									<navigator class="my_module" url="/pages/revelation/table" hover-class="hover">
										<div>
											<text>寻物启示</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/lost_and_found/table','get')">
									<navigator class="my_module" url="/pages/lost_and_found/table" hover-class="hover">
										<div>
											<text>失物招领</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/exchange_forum/table','get')">
									<navigator class="my_module" url="/pages/exchange_forum/table" hover-class="hover">
										<div>
											<text>交流论坛</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/item_type/table','get')">
									<navigator class="my_module" url="/pages/item_type/table" hover-class="hover">
										<div>
											<text>物品类型</text>
											<span>></span>
										</div>
