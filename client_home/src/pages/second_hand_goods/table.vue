    ...
    <view>
      <view class="container">
        ...
        ></uni-data-select>
                          ...
                          <uni-forms-item label="交易地址" name="transaction_address">
                      <uni-easyinput type="text" v-model="query.transaction_address" placeholder="交易地址" />
                    </uni-forms-item>
                    </uni-forms>
              <!-- /搜索栏 -->
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="0 && $check_field('get','item_no')">
						<view class="view">
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','item_specification')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>物品规格</span>
							</view>
															<view class="diy_field diy_text text">
								<span>
									{{ o["item_specification"] }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="1 && $check_field('get','item_quantity')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>物品数量</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','item_unit_price')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>物品单价</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','transaction_address')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>交易地址</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','product_description')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>商品描述</span>
							</view>
