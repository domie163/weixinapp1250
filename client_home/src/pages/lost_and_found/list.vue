<template>
	<view class="page_lost_and_found diy_list diy_list_page div_list_tml" id="lost_and_found_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?lost_and_found_id=' + o['lost_and_found_id']" class="btn btn-primary">查看详情</navigator>
		...
		data() {
			return {
				...
				list_item_type: [{value:"全部",text:"全部"}],
											// 物品状态选项列表
				list_item_status: [{value:"全部",text:"全部"}],
									// 用户列表
