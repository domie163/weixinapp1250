<template>
	<view class="page_exchange_forum diy_detail diy_detail--new" id="exchange_forum_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					<view v-if="$check_field('get','forum_title')" class="col-12 col-6">
						<view class="view">
					...
					<view v-if="$check_field('get','forum_label')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>论坛标签</span>
							</view>
					...
					<view v-if="$check_field('get','post_content')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>帖子内容</span>
							</view>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=exchange_forum&source_field=exchange_forum_id&source_id=' + obj['exchange_forum_id']">
							评论
						</navigator>
