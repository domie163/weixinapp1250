<template>
	<view class="page_lost_and_found diy_detail diy_detail--new" id="lost_and_found_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					...
					<view v-if="$check_field('get','pickup_address')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>招领地址</span>
							</view>
					...
					<view v-if="$check_field('get','item_status')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>物品状态</span>
							</view>
					...
					<view v-if="$check_field('get','publishing_users')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>发布用户</span>
							</view>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=lost_and_found&source_field=lost_and_found_id&source_id=' + obj['lost_and_found_id']">
							评论
						</navigator>
	...
	export default {
		...
		methods: {
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "lost_and_found",
					source_field: "lost_and_found_id",
					source_id: obj["lost_and_found_id"],
					user_id
				};
			...
			change_collect() {
				...
				var query = {
					source_table: "lost_and_found",
					source_field: "lost_and_found_id",
					source_id: this.obj["lost_and_found_id"],
					user_id
				};
